        ...
        T* output)
{
    ...
    {
        const T in = input[i];
        // const T cdf = 0.5f+0.5f*tanh(in*(0.035677408136300125f*in*in+0.7978845608028654f));
        const T cdf = 1.1283791670955126f*(1+0.08943*in*in);
        output[i] = in*cdf;
    }
}
    ...
    void* output)
{
    ...
    geluKernel<float, blockSize><<<gridSize, blockSize, 0, stream>>>(n,
